...
4. Если решение большое — предлагай 2-4 реалистичных варианта slicing.
5. Если изменение не тянет на `major`, верни его в обычный tiny-flow вместо создания тяжёлого процесса.
